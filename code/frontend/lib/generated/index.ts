// Temporary committed API client (stubbed/generated placeholder)
// This file was copied from the frontend API stub to serve as a canonical
// client until the generator output is committed.
